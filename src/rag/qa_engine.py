...
Combines functionality from rag.py and live_qa_pdf.py
"""
import os
import sys
...
class QAEngine:
    ...
    def _initialize_llm(self, model_name: str) -> HuggingFacePipeline:
        """
...
Answer: """
    ...
    def _generate_answer(self, prompt: str) -> str:
        ...
        """
        try:
            response = self.llm(prompt, max_length=1000)
